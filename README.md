...
## How to Use
Nothing is required of the user in order to take advantage of PhotoShareServer's features. As long as the server is running, users will automatically make benefit of what PhotoShareServer is doing while using the client-side PhotoShareApp. 
